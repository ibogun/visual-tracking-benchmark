...
def calc_result_single_sequece(tracker, seq, result, evalType):
    ...
    for attr in attrList:
        ...
        if attr.name in seq.attributes:
            ...
            overlapScore = sum(overlapList) / len(overlapList) if len(overlapList) > 0 else 0
